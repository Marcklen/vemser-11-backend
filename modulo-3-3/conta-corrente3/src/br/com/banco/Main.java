...
public class Main {
    public static void main(String[] args) {
        ...
        ContaCorrente contaCorrenteMarcklen = new ContaCorrente(marcklen, "1234-5", "0569", 500d, 500d);
        ContaPagamento contaPagamentoMarcklen = new ContaPagamento(marcklen, "1234-5", "0569", 100d);

        ContaPoupanca contaPoupancaMiguel = new ContaPoupanca(miguel, "1234-5", "0569", 200d);

//        System.out.println("-----------------------------------------");
//        System.out.println("IMPRIMINDO DADOS DA CONTA - MARCKLEN");
//        System.out.println("-----------------------------------------");
//        ((br.com.banco.ContaCorrente) contaCorrenteMarcklen).imprimir();
//        System.out.println("-----------------------------------------");
//        ((br.com.banco.ContaPagamento) contaPagamentoMarcklen).imprimir();
//        System.out.println("-----------------------------------------");
//        System.out.println("IMPRIMINDO DADOS DA CONTA - MIGUEL");
//        System.out.println("-----------------------------------------");
//        ((br.com.banco.ContaPoupanca) contaPoupancaMiguel).imprimir();
//        System.out.println("-----------------------------------------");
//        ((br.com.banco.ContaPoupanca) contaPoupancaMiguel).creditarTaxa();
//        ((br.com.banco.ContaPoupanca) contaPoupancaMiguel).imprimir();
//        System.out.println("-----------------------------------------");
...
//        ((br.com.banco.ContaPagamento) contaPagamentoMarcklen).imprimir();
//        System.out.println("-----------------------------------------");
        contaPagamentoMarcklen.imprimir();
        contaPagamentoMarcklen.transferir(contaCorrenteMarcklen, 20d);
        System.out.println("-----------------------------------------");
        contaPagamentoMarcklen.imprimir();
    }
}