...
public class PessoaRepositoryOld {
    ...
    public PessoaRepositoryOld() {
        ...
        listaPessoaEntities.add(new PessoaEntity(COUNTER.incrementAndGet() /*2*/, "Charles Pereira", LocalDate.parse("08/05/1985", formatter), "12345678911", "charles.pereira@gmail.com"));
        listaPessoaEntities.add(new PessoaEntity(COUNTER.incrementAndGet() /*3*/, "Marina Oliveira", LocalDate.parse("30/03/1970", formatter), "12345678912", "marina.oliveira@yahoo.com.br"));
        listaPessoaEntities.add(new PessoaEntity(COUNTER.incrementAndGet() /*4*/, "Rafael Lazzari", LocalDate.parse("01/07/1990", formatter), "12345678916", "rafael.lazzari@dbccompany.com.br"));
        listaPessoaEntities.add(new PessoaEntity(COUNTER.incrementAndGet() /*5*/, "Ana", LocalDate.parse("01/07/1990", formatter), "12345678917", "anajulia@loshermanos.com.br"));
    }
